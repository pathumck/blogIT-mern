...
function EditBlog() {
  ...
  useEffect(() => {
    if (blogData) {
      setPreview(blogData.data.featuredImage);
      form.setValue("category", blogData.data.category._id);
      form.setValue("title", blogData.data.title);
      form.setValue("slug", blogData.data.slug);
      form.setValue("blogContent", decode(blogData.data.blogContent));
    }
  }, [blogData]);
